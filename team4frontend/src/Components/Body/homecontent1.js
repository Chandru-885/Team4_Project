                ...
                <Container>
                    <Card className="cardContainer">
                        <Row>
                            ...
                            <Col md ={4}>
                                <Card.Img className="cardsImage" variant="top" src="https://www.pngkey.com/png/detail/64-644746_with-this-limited-time-offer-you-can-get.png" width="400px" height="400px" />
                            </Col>
                        </Row>
                    </Card>
                </Container>
