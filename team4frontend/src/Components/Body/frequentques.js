    ...
    return (
      <div>
        ...
        <div className="dealsForYouContent">
          ...
          <CardColumns>
            <Card>
              <Card.Img className="dealsForYouImage" variant="top" src="https://images-eu.ssl-images-amazon.com/images/G/31/img20/Books/112020/BxGy/720-X-375-Bxgy-Exam-7.jpg" />
            </Card>
            <Card>
              <Card.Img className="dealsForYouImage"variant="top" src="https://www.shopickr.com/wp-content/uploads/2015/09/amazon-india-books-sale-diwali-9-2015.jpg" />
            </Card>
            <Card>
              <Card.Img className="dealsForYouImage"variant="top" src="https://dealsupdate.in/wp-content/uploads/2013/08/Buy-Books-Online1.jpg"  />
            </Card>
          </CardColumns>
          <CardColumns>
            <Card>
              <Card.Img className="dealsForYouImage"variant="top" src="https://images-eu.ssl-images-amazon.com/images/G/31/img17/Westland/header_1_Jul._CB1198675309_.jpg" />
            </Card>
            <Card>
              <Card.Img className="dealsForYouImage"variant="top" src="https://www.compareraja.in/blog/wp-content/uploads/2014/01/flipkart-book-offers-1440x564_c.jpg"  />
            </Card>
            <Card>
              <Card.Img className="dealsForYouImage"variant="top" src="https://images-eu.ssl-images-amazon.com/images/G/31/img20/Books/112020/BxGy/bundles.jpg" />
              </Card>
          </CardColumns>
        </div>
        ...
        <div className="row" style={{color: 'black'}}>
          <div className="col-md-4 pt-2 pb-5">
            <img className="sellImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_s53AICaxOJpVQ3qklWscBF-E2WpFkmgjUg&usqp=CAU" alt=""/>
            <h3>E-Commerce</h3>
          ...
          <div className="col-md-4 pt-2 pb-5">
            <img  className="sellImage" src="https://m.media-amazon.com/images/G/01/SBP/2019/MakeMoneyOnAmazon/Start_Selling._CB465832615_.png"  alt=""/>
          ...
          <div className="col-md-4 pt-2 pb-5">
            <img  className="sellImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRP1eeiPQ0WzBrV-vh2_H0A7iuLlAd7FSXz78BUIeMVJTboov5Idv2v_8_f2C9r3hQsMbY&usqp=CAU" alt=""/>
